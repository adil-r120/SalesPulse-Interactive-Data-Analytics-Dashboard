...
const TOAST_LIMIT = 1
// Delay before removing dismissed toasts (in milliseconds)
...
// Interface defining the state structure for toasts
interface State {
  toasts: ToasterToast[]
}

// Map to track toast timeouts for automatic removal
...
// Function to dispatch actions to all listeners
...
// Type for toast objects (excluding id)
